    ...
    function onEntry(entry) {
      ...
      let elements = document.querySelectorAll('.block-services__cost, .block-free__list li, .block-free__text, .text__link, h2, .block-services__title, .block-services__paragraph,  h3, .foot, .number-stages__nomber, .number-stages__title, .number-stages__body');
